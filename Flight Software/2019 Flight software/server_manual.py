...
def threadmain():
    ...
    #Event box
    eventBox = tk.Label(height=26, width=121, justify="left", bg="white", name="eventBox", anchor="sw")
    eventBox.place(x=40, y=270)

    #Commands
    commandBox = tk.Entry(width=100, name="commandBox")
    commandBox.place(x=40, y=650)
    sendButton = tk.Button(text='SEND', name='sendButton', height=2, width=10, command=sendCommand)
    sendButton.place(x=920, y=650)
