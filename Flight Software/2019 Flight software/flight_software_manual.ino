...
//---------------------------------------------------------------------------------------------/
    ...
    void loop() {
        ...
        //GPS readings----------------------------------------------|
            ...
            /*if(millis()/1000 < 9000)
                _HABGPSreadings.altitude = (millis()/1000)*5;
            else
                _HABGPSreadings.altitude = 45000 - (millis()/1000 - 9000)*5;*/
            
            /*if(millis()/1000 < 150)
                _HABGPSreadings.altitude = (millis()/1000)*300;
            else
                _HABGPSreadings.altitude = 45000 - (millis()/1000 - 150)*300;*/  

            /*if(millis()/1000 < 1000)
                _HABGPSreadings.altitude = (millis()/1000)*45;
            else
                _HABGPSreadings.altitude = 45000 - (millis()/1000 - 1000)*45;*/                      
